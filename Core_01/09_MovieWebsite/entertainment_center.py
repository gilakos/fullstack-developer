...
blade_runner = media.Movie("Blade Runner",
                           "A dystopian future in which synthetic humans known as replicants are bioengineered to work on off-world colonies",
...
movies = [toy_story,blade_runner,school_of_rock,ratatouille,midnight_in_paris,hunger_games]
